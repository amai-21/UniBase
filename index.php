    ...
    <body>
        ...
        <div id="newdatadiv" style="display: block">
            ...
            <table>
                <tr>
                    ...
                    ?>
                    <td><input type="button" onclick="addNewRowJQ()" value="New Row"/></td>
                </tr>
            </table>
        </div>
        ...
        <!-- <table>
            <tr>
                ...
                <td><input type="button" onclick="showMaxValJQ(<?php print $mn; ?>)" value="Show Max"/></td>
            </tr>
        </table> -->
        <form id = "maxForm" onsubmit = "return false;">
            <select id = "columnSelect">
                ...
                <input type="button" onclick="showSelectedMax('<?php print $table_name; ?>')" value="Show Max" />
        </form>
        <div id = "mymax" style ="width:4em;background-color:lightgrey;display:inline-block;">&nbsp;</div>
    </body>
</html>
<?php
mysqli_close($conn);
